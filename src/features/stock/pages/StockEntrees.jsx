...
export default function StockEntrees() {
  ...
  // Filter only "entrée" movements
  const entreesMovements = mouvements.filter(
    (m) => m.typeMouvement === "entrée"
  );
    ...
    <div className="space-y-4 sm:space-y-6 p-3 sm:p-4 lg:p-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-[var(--color-foreground-muted)] text-xs sm:text-sm">
            Historique des entrées et réceptions de marchandises
          </p>{" "}
        </div>
        <Button
      ...
      <div className="bg-white rounded-lg border border-[var(--color-border)] shadow-sm p-3 sm:p-4 lg:p-6 w-full">
        ...
        <div className="mb-4">
          <div className="relative w-full">
            ...
            <Input
              ...
              className="pl-9 bg-[var(--color-surface)] border-[var(--color-border)] focus:border-green-600 focus:ring-2 focus:ring-green-600/20"
            />
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="p-8 text-center">
            <TrendingUp className="h-12 w-12 mx-auto text-[var(--color-foreground-muted)] mb-2" />
