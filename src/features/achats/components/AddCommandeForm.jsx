...
export const AddCommandeForm = ({ open, onOpenChange, onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const totalTTC = formData.articles.reduce(
      (sum, a) => sum + a.montantTTC,
      0
    );
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent className="bg-white border border-gray-200 rounded-md shadow-lg">
                    <SelectItem value="en attente" className="hover:bg-gray-50">
                      En attente
                    </SelectItem>
                    <SelectItem value="payé" className="hover:bg-gray-50">
                      Payé
                    </SelectItem>
                    <SelectItem value="annulé" className="hover:bg-gray-50">
                      Annulé
                    </SelectItem>
                  </SelectContent>
                </Select>
                        ...
                        {formData.articles.map((article) => (
                          <TableRow key={article.id}>
                            ...
                            <TableCell className="text-right font-medium">
                              {formatCurrency(article.montantTTC)} €
                            </TableCell>
                            <TableCell className="text-right">
                              <Button
                                type="button"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        value={prixUnitaire}
                        onChange={(e) =>
                          setPrixUnitaire(Number(e.target.value))
                        }
                        required
                      />
                    </div>
                    ...
                    <TableBody>
                      {formData.articles.map((article) => (
                        <TableRow key={article.id}>
                          ...
                          <TableCell className="text-right">
                            {formatCurrency(article.montantHT)}
                          </TableCell>
                          <TableCell className="text-right">
                            <Button
                              type="button"
                      ...
                      <div className="w-64 space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {formatCurrency(
                              formData.articles.reduce(
                                (sum, a) => sum + a.montantHT,
                                0
                              )
                            )}
                          </span>
